...
function mockKit(overrides: Record<string, jest.Mock> = {}) {
  return {
    getBalances: jest
      .fn()
      .mockResolvedValue([{ address: 'TAddr1', type: 'TRX', balance: '100000000' }]),
    ...
    mintPositionV4: jest
      .fn()
      .mockResolvedValue({ txResult: { txid: 'tx-v4-mint' }, tokenId: '99' }),
...
describe('sunswap tool handlers', () => {
  ...
  describe('sunswap_v3_increase_liquidity', () => {
    ...
    it('delegates to kit.increaseLiquidityV3', async () => {
      ...
      expect(kit.increaseLiquidityV3).toHaveBeenCalledWith(
        expect.objectContaining({ tokenId: '12345' }),
      )
    })
  ...
  describe('sunswap_v3_decrease_liquidity', () => {
    ...
    it('delegates to kit.decreaseLiquidityV3', async () => {
      ...
      expect(kit.decreaseLiquidityV3).toHaveBeenCalledWith(
        expect.objectContaining({ tokenId: '12345' }),
      )
    })
  ...
  describe('sunswap_v4_mint_position', () => {
    ...
    it('delegates to kit.mintPositionV4', async () => {
      ...
      expect(kit.mintPositionV4).toHaveBeenCalledWith(
        expect.objectContaining({
          token0: 'TToken0',
          token1: 'TToken1',
        }),
  ...
  describe('sunswap_v4_increase_liquidity', () => {
    ...
    it('delegates to kit.increaseLiquidityV4', async () => {
      ...
      expect(kit.increaseLiquidityV4).toHaveBeenCalledWith(
        expect.objectContaining({ tokenId: '99' }),
      )
    })
  ...
  describe('sunswap_v4_decrease_liquidity', () => {
    ...
    it('delegates to kit.decreaseLiquidityV4', async () => {
      ...
      expect(kit.decreaseLiquidityV4).toHaveBeenCalledWith(
        expect.objectContaining({ tokenId: '99' }),
      )
    })
